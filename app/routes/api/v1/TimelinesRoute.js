...
export default function addRoutes(app) {
  ...
  app.get(
    '/v1/timelines/filter/discussions',
    deprecated('Please use /v2/timelines/filter/discussions'),
  );
  ...
  app.get(
    '/v1/timelines/:username/comments',
    deprecated('Please use /v2/timelines/:username/comments'),
  );
}
