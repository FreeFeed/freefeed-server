export const alwaysAllowedRoutes = ['GET /v1/users/me', 'POST /v2/app-tokens/:tokenId/reissue'];

export const appTokensScopes = [
  {
    name: 'read-my-info',
    title: 'Read my user information',
    routes: ['GET /v2/users/whoami', 'GET /v2/managedGroups', 'GET /v2/users/blockedByMe'],
  },
  {
    name: 'read-feeds',
