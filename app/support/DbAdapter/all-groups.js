...
const allGroupsTrait = (superClass) =>
  class extends superClass {
    ...
    async getAllGroups(params = {}) {
      ...
      const [{ rows: subscribersRows }, { rows: postsRows }] = await Promise.all([
        subscribersRequest,
        postsRequest,
      ]);
      ...
      return groups.map((g) => ({
        ...
        authorsVariety: postsAuthorsMap.has(g.feedId)
          ? 1 - maxMapPercent(postsAuthorsMap.get(g.feedId))
          : 0,
      }));
    }
  };
