...
const tests = [
  ...
  { input: { deep: { prop: 'řádek'.normalize('NFD') } }, output: { deep: { prop: 'řádek'.normalize('NFC') } } },
  { input: { deep: [42, 'řádek'.normalize('NFD')] }, output: { deep: [42, 'řádek'.normalize('NFC')] } },
  { input: { ['klíč'.normalize('NFD')]: 'veličina'.normalize('NFD') }, output: { ['klíč'.normalize('NFC')]: 'veličina'.normalize('NFC') } },
];
