        ...
        it('should not allow banned user to send subscription request', (done) => {
          request
            ...
            .end(() => {
              request
                .post(
                  `${app.context.config.host}/v1/users/${lunaContext.user.username}/sendRequest`,
                )
                .send({
        ...
        it('should be able to reject', (done) => {
          request
            ...
            .end(() => {
              request
                .post(
                  `${app.context.config.host}/v1/users/rejectRequest/${herculesContext.user.username}`,
                )
                .send({
                  authToken: lunaContext.authToken,
                  _method: 'post',
                        ...
                        .end((err, res) => {
                          ...
                          funcTestHelper.getTimeline(
                            ...
                            (err, res) => {
                              ...
                              res.body.timelines.should.have.property('name');
                              res.body.timelines.name.should.eql('RiverOfNews');
                              res.body.timelines.should.satisfy(
                                funcTestHelper.noFieldOrEmptyArray('posts'),
                              );
