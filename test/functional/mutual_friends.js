    ...
    describe('are mutual friends', () => {
      ...
      it('should not publish liked direct message to home feed of mutual friends', (done) => {
        ...
        request
          ...
          .send({
            post: { body },
            meta: { feeds: [marsContext.username] },
        ...
        request
          ...
          .end((err, res) => {
            ...
            request
              ...
              .end(() => {
                funcTestHelper.getTimeline(
                  `/v2/timelines/${lunaContext.username}/likes`,
      ...
      it('should not publish commented direct message to comments feed', (done) => {
        ...
        request
          ...
          .end((err, res) => {
            ...
            funcTestHelper.createComment(body, post.id, lunaContext.authToken, () => {
              funcTestHelper.getTimeline(
                `/v2/timelines/${lunaContext.username}/comments`,
                lunaContext.authToken,
                (err, res) => {
                  if (err) {
                    done(err);
          ...
          .end((err, res) => {
            ...
            funcTestHelper.createComment(body, post.id, zeusContext.authToken, (err, res) => {
              try {
                ...
                res.body.err.should.eql('You can not see this post');
                done();
              } catch (e) {
                done(e);
              }
      ...
      it('should send direct message with @-mention', async () => {
        const postRequest = funcTestHelper.createAndReturnPostToFeed(
          marsContext,
          lunaContext,
          '@direct',
        );
