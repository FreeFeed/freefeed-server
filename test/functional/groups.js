...
describe('GroupsController', () => {
  ...
  describe('#create()', () => {
    ...
    it('should reject unauthenticated users', (done) => {
      request.post(`${app.context.config.host}/v1/groups`).end((err) => {
  ...
  describe('#admin', () => {
    ...
    it('should reject unauthenticated users', (done) => {
      request
        .post(
          `${app.context.config.host}/v1/groups/pepyatka-dev/subscribers/${nonAdminContext.username}/admin`,
        )
        .end((err) => {
          err.should.not.be.empty;
    ...
    it('should reject nonexisting group', (done) => {
      request
        .post(
          `${app.context.config.host}/v1/groups/foobar/subscribers/${nonAdminContext.uesrname}/admin`,
        )
  ...
  describe('#update', () => {
    ...
    beforeEach(async () => {
      context = await funcTestHelper.createUserAsync('Luna', 'password');
      const res = await funcTestHelper.createGroupAsync(
        context,
        'pepyatka-dev',
        'Pepyatka Developers',
      );
