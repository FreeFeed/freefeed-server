...
describe('Group', () => {
  ...
  describe('#create()', () => {
    ...
    it('should not create with tiny screenName', async () => {
      ...
      try {
        ...
        e.message.should.eql(
          `"${group.screenName}" is not a valid display name. Names must be between 3 and 25 characters long.`,
        );
        return;
      }
    ...
    it('should not create with username that already exists', (done) => {
      ...
      groupA
        .create()
        .then(() => {
          return groupB.create();
        })
        .then(() => {
          done(new Error('Creted group with existing username'));
        })
        .catch((e) => {
  ...
  describe('addAdministrator', () => {
    ...
    it('should add an administrator', (done) => {
      group
        .addAdministrator(groupAdmin.id)
  ...
  describe('removeAdministrator', () => {
    ...
    it('should remove an administrator', (done) => {
      group
        .removeAdministrator(groupAdmin.id)
        .then(() => group.getAdministratorIds())
        .then((res) => {
    ...
    it('should refuse to remove the last administrator', (done) => {
      group
        .removeAdministrator(secondGroupAdmin.id)
